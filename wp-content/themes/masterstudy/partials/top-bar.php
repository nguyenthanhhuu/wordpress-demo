				...
				<div class="pull-right xs-pull-left">
					<ul class="top_bar_info clearfix">
						<?php if( $top_bar_working_hours ){ ?>
							<li <?php if(!$top_bar_working_hours_mobile){ ?>class="hidden-info"<?php } ?>><i class="fa fa-clock-o"></i> <?php echo balanceTags( $top_bar_working_hours, true ); ?></li>
						<?php } ?>
						<?php if( $top_bar_address ){ ?>
							<li <?php if(!$top_bar_address_mobile){ ?>class="hidden-info"<?php } ?>><i class="fa fa-map-marker"></i> <?php echo balanceTags( $top_bar_address, true ); ?></li>
						<?php } ?>
						<?php if( $top_bar_phone ){ ?>
							<li <?php if(!$top_bar_phone_mobile){ ?>class="hidden-info"<?php } ?>><i class="fa fa-phone"></i> <?php echo balanceTags( $top_bar_phone, true ); ?></li>
						<?php } ?>
					</ul>
				</div>
			<?php endif; ?>
