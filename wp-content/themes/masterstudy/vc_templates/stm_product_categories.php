	...
	<div class="product_categories_main_wrapper">		
		...
		<?php endif; ?>
			...
			?>
				...
				<div class="single-course-col">
					<a href="<?php echo esc_attr(get_term_link($term)); ?>" title="<?php _e('View course', STM_DOMAIN) ?>">
						<div class="project_cat_single_item <?php echo esc_attr( $css_class ); ?> text-<?php echo esc_attr($text_align); ?>" style="background-color:<?php echo esc_attr($item_clr); ?>; color: <?php echo esc_attr($box_text_color); ?>">
