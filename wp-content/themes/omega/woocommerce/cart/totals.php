		...
		<table class="table">
			<tbody>
				...
				<tr class="cart-subtotal">
					<td><strong><?php _e( 'Cart Subtotal', 'woocommerce' ); ?></strong></td>
				...
				<?php if ( $woocommerce->cart->get_discounts_before_tax() ) : ?>
					...
					<tr class="discount">
						<td><?php _e( 'Cart Discount', 'woocommerce' ); ?> <a href="<?php echo add_query_arg( 'remove_discounts', '1', $woocommerce->cart->get_cart_url() ) ?>"><?php _e( '[Remove]', 'woocommerce' ); ?></a></td>
				...
				<?php if ( $woocommerce->cart->needs_shipping() && $woocommerce->cart->show_shipping() && ( $available_methods || get_option( 'woocommerce_enable_shipping_calc' ) == 'yes' ) ) : ?>
					...
					<tr class="shipping">
						<td><strong><?php _e( 'Shipping', 'woocommerce' ); ?></strong></td>
				...
				<?php if ( $woocommerce->cart->get_discounts_after_tax() ) : ?>
					...
					<tr class="discount">
						<td><?php _e( 'Order Discount', 'woocommerce' ); ?> <a href="<?php echo add_query_arg( 'remove_discounts', '2', $woocommerce->cart->get_cart_url() ) ?>"><?php _e( '[Remove]', 'woocommerce' ); ?></a></td>
