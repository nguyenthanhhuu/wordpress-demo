...
<tr id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<td class="bbp-topic-title">
		...
		<p class="bbp-topic-meta">
			...
			<span class="bbp-topic-started-by"><?php printf( __( 'Started by: %1$s', 'omega-td' ), bbp_get_topic_author_link( array( 'size' => '16', 'type' => 'name' ) ) ); ?></span>
			...
			<?php if ( !bbp_is_single_forum() || ( bbp_get_topic_forum_id() !== bbp_get_forum_id() ) ) : ?>
				...
				<span class="bbp-topic-started-in"><?php printf( __( 'in: <a href="%1$s">%2$s</a>', 'omega-td' ), bbp_get_forum_permalink( bbp_get_topic_forum_id() ), bbp_get_forum_title( bbp_get_topic_forum_id() ) ); ?></span>
