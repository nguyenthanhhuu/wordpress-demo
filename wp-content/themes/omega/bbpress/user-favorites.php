...
?>
	...
	<div id="bbp-user-favorites" class="bbp-user-favorites panel panel-primary panel-bbpress">
		<div class="panel-heading">
			<?php _e( 'Favorite Forum Topics', 'omega-td' ); ?>
		</div>
		...
		<div class="bbp-user-section">
			...
			<?php else : ?>
				...
				<p><?php bbp_is_user_home() ? _e( 'You currently have no favorite topics.', 'omega-td' ) : _e( 'This user has no favorite topics.', 'omega-td' ); ?></p>
