...
?>
	...
	<div id="bbp-user-topics-started" class="bbp-user-topics-started bbp-user-profile panel panel-primary panel-bbpress">
		...
		<div class="panel-heading">
			<?php _e( 'Forum Topics Started', 'omega-td' ); ?>
		</div>
		...
		<div class="bbp-user-section">
			...
			<?php else : ?>
				...
				<p><?php bbp_is_user_home() ? _e( 'You have not created any topics.', 'omega-td' ) : _e( 'This user has not created any topics.', 'omega-td' ); ?></p>
