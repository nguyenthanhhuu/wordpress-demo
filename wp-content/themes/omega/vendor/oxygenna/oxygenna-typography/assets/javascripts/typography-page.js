        ...
        function updateFontTable() {
            ...
            if( fontstack.length > 0 ) {
                _.each( fontstack, function( font ) {
                    ...
                    var variantsDetails = providerName === 'Google Fonts' ? fontVariantsList( font ) : '-';
                    var elementsDetails = providerName === 'Google Fonts' ? fontElementsList( font ) : '-';
                    var subsetsDetails = providerName === 'Google Fonts' ? fontSubsetsList( font ) : '-';
                    // create new row
                    var $tr = jQuery('<tr></tr>');
                    // add font data to row
                    $tr.append( '<td>' + font.family + '</td>' );
                    $tr.append( '<td>' + providerName + '</td>' );
                    $tr.append( '<td class="variants">' + variantsDetails + '</td>' );
                    $tr.append( '<td class="elements">' + elementsDetails + '</td>' );
                    $tr.append( '<td class="subsets">' + subsetsDetails + '</td>' );
